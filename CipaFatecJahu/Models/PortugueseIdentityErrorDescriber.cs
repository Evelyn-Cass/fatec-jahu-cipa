...
namespace CipaFatecJahu.Models
{
    public class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = "Falha de ocorrência, o objeto foi modificado." }; }
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = string.Empty }; }
